...
##Initailly, I used only one dataset structure for both models, but later I decided to use two different structures for each model, 
# because of the different requirements for  of the two models.
##This is a python script that I used for the first dataset downloaded from Roboflow after finishing the annotation work.
#  to separate the images in the test set into two folders: originals and ground_truth

# Paths to dataset
dataset_root = r'C:\Users\Dell\Documents\Desktop\A. ĐỒ ÁN TỔNG HỢP AI\code\dataset\test' 
coco_file = r'C:\Users\Dell\Documents\Desktop\A. ĐỒ ÁN TỔNG HỢP AI\code\dataset\test\_annotations.coco.json'   
